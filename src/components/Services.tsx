    ...
    <section id="services" className="py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            <motion.div className="md:w-1/2" variants={textVariant}>
              <h3 className="text-3xl font-semibold mb-4">Warranty Service</h3>
              <p className="text-lg">Unlock peace of mind with our Warranty Service – because your trust deserves protection. 🛡️✨</p>
            </motion.div>
            <motion.div className="md:w-1/2" variants={imageVariant}>
              <Image
